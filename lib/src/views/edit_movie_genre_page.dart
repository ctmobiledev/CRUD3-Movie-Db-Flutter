...
import 'package:car_genius_app/src/viewmodels/edit_movie_genre_viewmodel.dart';
import 'package:car_genius_app/src/views/edit_movie_genre_page_args.dart';
...
class EditMovieGenreWidgetState extends State<EditMovieGenreWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (args.id > 0) {
      var movieModelGenreValues = MainRepository.realmMovieGenres
    ...
    var moreThanOneEntry = (MainRepository.realmMovieGenres.length > 1);

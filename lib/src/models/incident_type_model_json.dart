...
// It DOES have the exact same properties as _IncidentTypeModel (private) and IncidentTypeModel (public).
//
class IncidentTypeModelJson {
  int? id = -1;
  ...
  IncidentTypeModelJson(int pId, String pTimestamp, String pDay, String pTitle,
  ...
  factory IncidentTypeModelJson.fromJson(dynamic json) {
    return IncidentTypeModelJson(
        json['id'] as int,

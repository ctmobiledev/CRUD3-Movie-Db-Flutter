...
class LastTimeReportModelJson {
  int? id = -1;
  String? movieGenreName;

  LastTimeReportModelJson(int pId, String pGenre) {
    id = pId;
  ...
  factory LastTimeReportModelJson.fromJson(dynamic json) {
    return LastTimeReportModelJson(
      json['id'] as int,

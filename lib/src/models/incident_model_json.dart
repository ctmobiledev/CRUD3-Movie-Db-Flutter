...
class IncidentModelJson {
  ...
  IncidentModelJson(int pId, String pTimestamp, String pDay, String pTitle,
  ...
  factory IncidentModelJson.fromJson(dynamic json) {
    return IncidentModelJson(
        json['id'] as int,
